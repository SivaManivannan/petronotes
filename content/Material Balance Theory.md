...
Considering a control volume that includes the reservoir and all the wells in it, the general form of the mass balance can be stated as:
	*Fluids withdrawn - Fluids injected (@ reservoir conditions) = Oil & dissolved gas expansion +    Gas expansion in Gas cap + Water influx + Rock compression adding to production*
